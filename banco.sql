...
('gildo.png', 'Gildo', 'Silvana Rando', 'Brinque-Book', '2 - 5 anos', 'Gildo é muito corajoso. Mas como quase todo mundo, existe uma coisa que o deixa apavorado... '),
...
('estrelas e planetas.png', 'Estrelas e planetas', 'Pierre Winters', 'Brinque-Book', '4 - 7 anos', 'Você quer saber tudo sobre estrelas e planetas? Por que existe o dia e a noite? Por que o formato da Lua muda? o Sol é uma estrela? Que planetas existem?'),
...
('monstro rosa.png', 'Monstro rosa', 'Olga de Dios', 'Boitatá', '3 anos', 'Monstro Rosa é uma história sobre como as diferenças podem unir as pessoas, um verdadeiro grito de liberdade. Seu protagonista é um estranho no ninho: um ser que, antes mesmo de vir ao mundo, já era diferente dos outros.'),
...
('carta errante.png', 'Carta errante, vó atrapalhada, menina aniversariante', 'Mirna Pinsky', 'FTD', '9 - 12 anos', 'Pedro trabalhava nos correios e sua função era responder cartas enviadas para Papai Noel e Super-Homem, descobrir endereços incompletos, traduzir caligrafias ilegíveis...'),
...
('a grande fabrica.png', 'A grande fábrica de palavras', 'Agnès Lestrade', 'Aletria', '6 - 10 anos', 'Existe um país onde as pessoas quase não falam. O Philéas precisa de palavras para abrir seu coração à doce Cybelle. Mas como fazê-lo se tudo o que ele tem vontade de dizer à Cybelle custa uma fortuna?'),
