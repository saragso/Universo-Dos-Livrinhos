...
('para onde vamos.png', 'Para onde vamos quando desaparecemos?', 'Isabel Minhós Martins', 'Planeta Tangerina', '8 - 10 anos', 'Já parou para pensar aonde vão as meias sem par? A areia da praia levada pelo vento? E o barulho, quando tudo fica em silêncio? Esses são alguns dos mistérios que a vida distribui aos montes, e a verdade é que a algumas perguntas nem mesmo os adultos conseguem responder com certeza.'),
('um dia muito mal humorado.png', 'Um dia muito mal-humorado', 'Stella J. Jonas', 'Ciranda Cultural', '2 - 5 anos', 'Uma grande onde de mau humor está se espalhando pela floresta! Começa com o urso, aborrece a toupeira... que se exalta com o ouriço, que é espinhoso com a raposa. Logo o mau humor do urso deixou todo mundo mal-humorado! será que um pouquinho de amor pode deixar todos felizes de novo?'),
...
('a magica da respiracao.png', 'A máfica da respiração', 'Christopher Willard', 'Caminho Suave', '3 - 7 anos', 'Todos nós vivemos dias difíceis de vez em quando. Temos sentimentos desagradáveis, como raiva, medo, solidão ou até uma tristeza mais profunda. Respire junto com esta história para descobrir algo que você já faz e que tem um poder mágico de transformar seus dias.'),
...
('posso ficar no meio.png', 'Posso ficar no meio?', 'Susanne Strasser', 'Companhia das Letrinhas', '2 anos', 'Chegou a hora da leitura! A criança chama o hamster para ler ao seu lado no sofá, e logo chegam também a zebra, o gato e o leão. Mas a cegonha ainda não apareceu e o peixe também está atrasado… Quando será que todos vão conseguir se reunir para que a história finalmente possa começar?'),
('meu corpinho.png', 'Meu corpinho é só meu', 'Lara Nogueira', 'Editora Inverso', '3 - 5 anos', 'Como contribuir para um mundo melhor? Para a autora, Lara Nogueira, é ajudando as crianças a compreenderem o quanto suas vidas são importantes! pensando nisso, ela escreveu a história da pequena Maria e da descoberta de que seu corpinho é... só dela! Conheça essa história você também!'),
('gildo.png', 'Gildo', 'Silvana Rando', 'Brinque-Book', '2 - 5 anos', 'Gildo é muito corajoso. Ele gosta de montanha-russa, de avião, de filme de terror e de cantar em público. Mas como quase todo mundo, existe uma coisa que o deixa apavorado... Sempre na noite anterior a alguma festinha de aniversário de um amigo, ele não consegue pregar os olhos, por que será?'),
...
('estrelas e planetas.png', 'Estrelas e planetas', 'Pierre Winters', 'Brinque-Book', '4 - 7 anos', 'Você quer saber tudo sobre estrelas e planetas? Aqui, você terá muitas informações sobre a Terra, a Lua, o Sol, as estrelas e outros planetas. Por que existe o dia e a noite? Por que o formato da Lua muda? o Sol é uma estrela? Que planetas existem? Para essas e muitas outras dúvidas, você terá respostas.'),
...
('carta errante.png', 'Carta errante, vó atrapalhada, menina aniversariante', 'Mirna Pinsky', 'FTD', '9 - 12 anos', 'Pedro Boné trabalhava nos correios e sua função era responder cartas enviadas para Papai Noel e Super-Homem, descobrir endereços incompletos, traduzir caligrafias ilegíveis... Ele gastava dias e noites para evitar que essas cartas fossem parar no lixo.'),
...
('a grande fabrica.png', 'A grande fábrica de palavras', 'Agnès Lestrade', 'Aletria', '6 - 10 anos', 'Existe um país onde as pessoas quase não falam. Nesse estranho país, é preciso comprar palavras para poder pronunciá-las. O pequeno Philéas precisa de palavras para abrir seu coração à doce Cybelle. Mas como fazê-lo se tudo o que ele tem vontade de dizer à Cybelle custa uma fortuna?'),
