...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['id_usuario'])) {
        ...
        if ($stmt_user = $conexao->prepare($sql_delete_user)) {
            ...
            if ($stmt_user->execute()) {
                ...
                if ($stmt_emprestimos = $conexao->prepare($sql_delete_emprestimos)) {
                    ...
                    if ($stmt_emprestimos->execute()) {
                        ...
                        header("Location: usuariosAdmin.html?error=emprestimos_execution");
                        exit();
                    }
                } else {
                    ...
                    header("Location: usuariosAdmin.html?error=emprestimos_prepare");
                    exit();
                }
            } else {
                ...
                header("Location: usuariosAdmin.html?error=user_execution");
                exit();
            }
        } else {
            ...
            header("Location: usuariosAdmin.html?error=user_prepare");
            exit();
        }
    } else {
